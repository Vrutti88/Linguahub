...
export const users = [
...

    {
        ...
        lessonXp: {
            "japanese_greetings": 20
        },
        quizXp: {
            "quiz_japanese_greetings": 30
        },
...
/* =====================================================
   LESSONS (9) — WITH IMAGE / AUDIO / VIDEO
===================================================== */

export const lessons = [
    /* 🇪🇸 Spanish */
    {
        _id: new mongoose.Types.ObjectId(), title: "Spanish Greetings", description: "Basic greetings in Spanish", language: "Spanish", level: "beginner", estimatedTime: "10 mins", order: 1, createdBy: users[6]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "Spanish Common Words", description: "Common Spanish words", language: "Spanish", level: "beginner", estimatedTime: "10 mins", order: 2, createdBy: users[6]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "Spanish Numbers", description: "Spanish numbers", language: "Spanish", level: "beginner", estimatedTime: "8 mins", order: 3, createdBy: users[6]._id,
        contents: [
    ...
    /* 🇫🇷 French */
    {
        _id: new mongoose.Types.ObjectId(), title: "French Greetings", description: "French greetings", language: "French", level: "beginner", estimatedTime: "10 mins", order: 1, createdBy: users[7]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "French Travel Phrases", description: "Travel phrases", language: "French", level: "intermediate", estimatedTime: "15 mins", order: 2, createdBy: users[7]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "Advanced French Expressions", description: "Formal French", language: "French", level: "advanced", estimatedTime: "20 mins", order: 3, createdBy: users[7]._id,
        contents: [
    ...
    /* 🇮🇳 Hindi */
    {
        _id: new mongoose.Types.ObjectId(), title: "Hindi Greetings", description: "Hindi greetings", language: "Hindi", level: "beginner", estimatedTime: "10 mins", order: 1, createdBy: users[6]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "Hindi Daily Words", description: "Daily Hindi words", language: "Hindi", level: "beginner", estimatedTime: "10 mins", order: 2, createdBy: users[6]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "Hindi Travel Phrases", description: "Travel Hindi", language: "Hindi", level: "intermediate", estimatedTime: "15 mins", order: 3, createdBy: users[6]._id,
        contents: [
    ...
    /* 🇬🇧 English */
    {
        _id: new mongoose.Types.ObjectId(), title: "English Greetings", description: "English greetings", language: "English", level: "beginner", estimatedTime: "8 mins", order: 1, createdBy: users[7]._id,
        contents: [
            { src: "Hello", target: "Hello", pronunciation: "heh-lo", imageUrl: "/img/hello.png", audioUrl: "/audio/hello.mp3", videoUrl: "/video/hello.mp4" }
        ]
    },
    {
        _id: new mongoose.Types.ObjectId(), title: "English Daily Conversations", description: "Daily conversations", language: "English", level: "intermediate", estimatedTime: "12 mins", order: 2, createdBy: users[7]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "English Professional Phrases", description: "Professional English", language: "English", level: "advanced", estimatedTime: "15 mins", order: 3, createdBy: users[7]._id,
        contents: [
    ...
    /* 🇯🇵 Japanese */
    {
        _id: new mongoose.Types.ObjectId(), title: "Japanese Greetings", description: "Japanese greetings", language: "Japanese", level: "beginner", estimatedTime: "12 mins", order: 1, createdBy: users[7]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "Japanese Daily Words", description: "Daily Japanese", language: "Japanese", level: "beginner", estimatedTime: "12 mins", order: 2, createdBy: users[7]._id,
        contents: [
    ...
    /* 🇩🇪 German */
    {
        _id: new mongoose.Types.ObjectId(), title: "German Basics", description: "German basics", language: "German", level: "beginner", estimatedTime: "10 mins", order: 1, createdBy: users[6]._id,
        contents: [
            { src: "Hallo", target: "Hello", pronunciation: "hah-lo", imageUrl: "/img/hallo.png", audioUrl: "/audio/hallo.mp3", videoUrl: "/video/hallo.mp4" }
        ]
    },
    {
        _id: new mongoose.Types.ObjectId(), title: "German Travel Words", description: "German travel", language: "German", level: "beginner", estimatedTime: "12 mins", order: 2, createdBy: users[6]._id,
        contents: [
    ...
    /* 🇰🇷 Korean */
    {
        _id: new mongoose.Types.ObjectId(), title: "Korean Greetings", description: "Korean greetings", language: "Korean", level: "beginner", estimatedTime: "10 mins", order: 1, createdBy: users[7]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "Korean Daily Words", description: "Daily Korean", language: "Korean", level: "beginner", estimatedTime: "10 mins", order: 2, createdBy: users[7]._id,
        contents: [
    ...
    /* 🇮🇹 Italian */
    {
        _id: new mongoose.Types.ObjectId(), title: "Italian Food Words", description: "Italian food", language: "Italian", level: "beginner", estimatedTime: "8 mins", order: 1, createdBy: users[6]._id,
        contents: [
            { src: "Pizza", target: "Pizza", pronunciation: "peet-sa", imageUrl: "/img/pizza.png", audioUrl: "/audio/pizza.mp3", videoUrl: "/video/pizza.mp4" }
        ]
    },
    {
        _id: new mongoose.Types.ObjectId(), title: "Italian Cafe Phrases", description: "Cafe phrases", language: "Italian", level: "beginner", estimatedTime: "10 mins", order: 2, createdBy: users[6]._id,
        contents: [
    ...
    /* 🇨🇳 Chinese */
    {
        _id: new mongoose.Types.ObjectId(), title: "Chinese Greetings", description: "Chinese greetings", language: "Chinese", level: "beginner", estimatedTime: "10 mins", order: 1, createdBy: users[7]._id,
        contents: [
            { src: "你好", target: "Hello", pronunciation: "ni-hao", imageUrl: "/img/nihao.png", audioUrl: "/audio/nihao.mp3", videoUrl: "/video/nihao.mp4" }
        ]
    },
    {
        _id: new mongoose.Types.ObjectId(), title: "Chinese Common Characters", description: "Chinese basics", language: "Chinese", level: "beginner", estimatedTime: "12 mins", order: 2, createdBy: users[7]._id,
        contents: [
    ...
    /* 🇷🇺 Russian */
    {
        _id: new mongoose.Types.ObjectId(), title: "Russian Greetings", description: "Russian greetings", language: "Russian", level: "beginner", estimatedTime: "10 mins", order: 1, createdBy: users[7]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "Russian Common Words", description: "Russian basics", language: "Russian", level: "beginner", estimatedTime: "10 mins", order: 2, createdBy: users[7]._id,
        contents: [
    ...
    /* 🇸🇦 Arabic */
    {
        _id: new mongoose.Types.ObjectId(), title: "Arabic Greetings", description: "Arabic greetings", language: "Arabic", level: "beginner", estimatedTime: "10 mins", order: 1, createdBy: users[7]._id,
        contents: [
    ...
    {
        _id: new mongoose.Types.ObjectId(), title: "Arabic Daily Words", description: "Daily Arabic", language: "Arabic", level: "beginner", estimatedTime: "10 mins", order: 2, createdBy: users[7]._id,
        contents: [
    ...
    /* 🇵🇹 Portuguese */
    {
        _id: new mongoose.Types.ObjectId(), title: "Portuguese Greetings", description: "Portuguese greetings", language: "Portuguese", level: "beginner", estimatedTime: "10 mins", order: 1, createdBy: users[6]._id,
        contents: [
            { src: "Olá", target: "Hello", pronunciation: "oh-la", imageUrl: "/img/ola.png", audioUrl: "/audio/ola.mp3", videoUrl: "/video/ola.mp4" }
        ]
    },
    {
        _id: new mongoose.Types.ObjectId(), title: "Portuguese Travel Phrases", description: "Portuguese travel", language: "Portuguese", level: "beginner", estimatedTime: "12 mins", order: 2, createdBy: users[6]._id,
        contents: [
